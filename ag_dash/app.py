            ...
            dbc.Card(
                [
                    ...
                    dbc.CardBody([
                        dbc.Row([
                            dbc.Col([
                                dcc.Graph(id='nvidia_roi', figure={},
                                          config={'displayModeBar':False})
                            ])
                        ]),
                    ]),
            ...
            dbc.Card(
                [
                    ...
                    dbc.CardBody([
                        dbc.Row([
                            dbc.Col([
                                dcc.Graph(id='bitcoin_roi', figure={},
                                          config={'displayModeBar':False})
                            ])
                        ]),
                    ]),
            ...
            dbc.Card(
                [
                    ...
                    dbc.CardBody([
                        dbc.Row([
                            dbc.Col([
                                dcc.Graph(id='ethereum_roi', figure={},
                                          config={'displayModeBar':False})
                            ])
                        ]),
                    ]),
